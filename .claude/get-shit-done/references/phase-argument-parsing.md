...
```bash
PHASE_INFO=$(node "/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
