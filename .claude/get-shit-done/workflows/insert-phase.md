...
```bash
INIT=$(node "/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
