...
Reference full template: `/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/templates/state.md`.
