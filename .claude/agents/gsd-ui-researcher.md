...
Use template from `/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/data/data/com.termux/files/home/repos/adminpro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
