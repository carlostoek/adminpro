...
must_haves:
  truths:
    ...
    - "VIP menu shows at least 2 variations for greeting message using equal random selection"
...
**Voice guidelines:**
- Use "círculo exclusivo" for VIP channel
- Use "invitación" for token
- Use "calibración" for setup
- Reference Diana for authority ("Diana prefiere...", "Diana aprobará...")
...
7. 2 greeting variations implemented in vip_menu()
...
2. VIP menu shows at least 2 variations for greeting
