...
**Plans:**
- [x] 26-01-PLAN.md — Create Alembic data migration (BotConfig update, user backfill, rewards seed)
- [x] 26-02-PLAN.md — Create Python seeder module for rewards with conditions
- [x] 26-03-PLAN.md — Create shop products seeder with content sets
