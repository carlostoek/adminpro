...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        ('♥ Encanto Inicial 💫',
         ...
         150.00, 'FREE_CONTENT', 'BUNDLE', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
        ...
        ('🔴 Sensualidad Revelada 🔥',
         ...
         200.00, 'FREE_CONTENT', 'BUNDLE', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
        ...
        ('❤‍🔥 Pasión Desbordante 💋',
         ...
         250.00, 'FREE_CONTENT', 'BUNDLE', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
        ...
        ('❤️ Intimidad Explosiva 🔞',
         ...
         300.00, 'FREE_CONTENT', 'BUNDLE', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
        ...
        ('💎 El Diván de Diana 💎',
         ...
         350.00, 'VIP_PREMIUM', 'COLLECTION', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
    """)
