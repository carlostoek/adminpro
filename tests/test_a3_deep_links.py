...
@pytest.mark.asyncio
async def test_generate_token_with_plan(mock_bot, test_session):
    """
...
@pytest.mark.asyncio
async def test_activate_vip_from_deep_link(mock_bot, test_session):
    """
...
@pytest.mark.asyncio
async def test_deep_link_format(mock_bot, test_session):
    """
...
@pytest.mark.asyncio
async def test_extend_vip_via_deep_link(mock_bot, test_session):
    """
...
@pytest.mark.asyncio
async def test_backward_compatibility_token_without_plan(mock_bot, test_session):
    """
...
@pytest.mark.asyncio
async def test_token_expiry_validation(mock_bot, test_session):
    """
...
@pytest.mark.asyncio
async def test_token_single_use(mock_bot, test_session):
    """
